...
public class SnowpackManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        snowWaterEquivalent += snowfallRateSWE_per_sec * Time.deltaTime;
        ...
        if (snowTemperature >= meltingTemperature)
        {
            ...
            // Convert melt rate to SWE per second
            float meltRateSWE_per_sec = meltRateSWE_per_day / (24.0f * 3600.0f);

            // Calculate melted SWE this frame
            meltSWE_this_frame = meltRateSWE_per_sec * Time.deltaTime;
